...
app.post('/customer',async function(req, res){
    // Column Names
    const custAttributes = ':cust_id, :cust_status_id, :state_id, :name, :address, :city, :state, :zip, :phone, :email';
    // Values
    let cust_id = req.body.cust_id;
    ...
    let binds = [cust_id, cust_status_id, state_id, name, address, city, state, zip, phone, email];
    let CRUDOP = await crudOP(query, binds, false);
...
app.post('/customervehicle', async function(req, res) {
    ...
    let binds = [cust_status_id, state_id, first_name, middle_in, last_name, city, address, zip, phone, email];
    ...
    let vehicleBinds = [lastRow, model_id, color_id, year, license_plate, state_id, vin];
